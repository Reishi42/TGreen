		...
		if ("me")
			...
			if (src.client)
				if (client.prefs.muted & MUTE_IC)
					src << "<span class='danger'>���-�� ������ ��� (muted).</span>"
					return
			...
			if(!(message))
				return
			if(copytext(message,1,5) == "�������")
				src << "<span class='danger'>Invalid emote.</span>"
				return
			else if(copytext(message,1,9) == "����������")
				src << "<span class='danger'>Invalid emote.</span>"
				return
			else if(copytext(message,1,6) == "���")
				src << "<span class='danger'>Invalid emote.</span>"
				return
			else if(copytext(message,1,5) == "����������")
				src << "<span class='danger'>Invalid emote.</span>"
				return
			else
