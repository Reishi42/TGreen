...
/obj/item/clothing/mask/gas/voice/space_ninja/speechModification(message)
	if(voice == "Unknown")
		if(copytext(message, 1, 2) != "*")
			...
			message = replacetext_char(message, "l", "r")
			message = replacetext_char(message, "rr", "ru")
			message = replacetext_char(message, "v", "b")
			message = replacetext_char(message, "f", "hu")
			message = replacetext_char(message, "'t", "")
			message = replacetext_char(message, "t ", "to ")
			message = replacetext_char(message, " I ", " ai ")
			message = replacetext_char(message, "th", "z")
			message = replacetext_char(message, "is", "izu")
			message = replacetext_char(message, "ziz", "zis")
			message = replacetext_char(message, "se", "su")
			message = replacetext_char(message, "br", "bur")
			message = replacetext_char(message, "ry", "ri")
			message = replacetext_char(message, "you", "yuu")
			message = replacetext_char(message, "ck", "cku")
			message = replacetext_char(message, "eu", "uu")
			message = replacetext_char(message, "ow", "au")
			message = replacetext_char(message, "are", "aa")
			message = replacetext_char(message, "ay", "ayu")
			message = replacetext_char(message, "ea", "ii")
			message = replacetext_char(message, "ch", "chi")
			message = replacetext_char(message, "than", "sen")
